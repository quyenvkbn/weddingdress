    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Hình ảnh của bộ sưu tập</h3>
                    </div>
                    <div class="box-body" style="">
                        <label>Hình ảnh bên trái</label>
                        <div class="row">
                            <div class="item col-md-12">
                                <div class="">
                                    <img src="<?php echo base_url('assets/upload/'.$controller.'/'.$detail['slug'].'/'. $detail['image_left'] ) ?>" alt="Image Detail" width=100% height=200px>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="item col-md-12">
                                <div class="">
                                    <img src="<?php echo base_url('assets/upload/'.$controller.'/'.$detail['slug'].'/'. $detail['image_right'] ) ?>" alt="Image Detail" width=100% height=200px>
                                </div>
                            </div>
                        </div>
                    </div>
