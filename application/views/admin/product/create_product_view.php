                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                        <div class="col-md-12" style="margin-top:5px;">
                                            ...
                                            <?php  
                                                echo form_input("price", '', 'class="form-control" onkeypress=" return isNumberKey(event)" id="price"');
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label class="col-xs-6">
                                              <input type="checkbox" name="sale" onclick="check_sale(this)"> Khuyến mãi
                                            </label>
                                        </div>
                                    </div>

                                    <div class="col-md-12" id="sale" style="display: none;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            <label class="col-xs-6" style="margin-top: 10px;">
                                              <input type="checkbox" name="rent" onclick="check_rent(this)"> Cho thuê
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-12" style="border:1px solid #d2d6de;">
                                            <div class="col-md-12" style="padding: 0px;margin-bottom: 10px;">
                                                <div class="col-md-12" style="padding: 0px;margin-top:5px;">
                                                    ...
                                                    <?php  
                                                        echo form_input("price_rent", '', 'class="form-control" onkeypress=" return isNumberKey(event)" id="price_rent"');
                                                    ?>
                                                </div>
                                            ...
                                            <div class="col-md-12" style="padding: 0px;">
                                                <div class="checkbox">
                                                    <label class="col-xs-6" style="margin-bottom: 5px;">
                                                      <input type="checkbox" name="rent_sale" onclick="check_rent_sale(this)"> Khuyến mãi
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-12" id="rent_sale" style="margin-bottom: 10px;padding: 0px;display: none;">
                                                <div class="col-xs-12" style="border:1px solid #d2d6de;margin-bottom: 10px;">
                                                    <?php
                                                        ...
                                                        echo form_input('pricepromotion_rent', "", 'class="form-control" id="pricepromotion_rent" placeholder ="Đơn vị tiền: VNĐ" onkeypress=" return isNumberKey(event)"');
                                                    ?>
                                                    <div class="checkbox">
                                                        <label style="padding-right: 10px;padding-bottom: 10px;">
                                                            <input type="checkbox" id="showpromotion_rent" name="showpromotion_rent"> Hiển thị khuyến mãi
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- <script>
  $(function () {
    ...
    $('#datepicker').datepicker({
      format: 'dd/mm/yyyy',
      multidate:true,
      datesDisabled:['09/10/2018','10/10/2018','11/10/2018','12/10/2018','13/10/2018','14/10/2018','15/10/2018','17/10/2018']
    })
  })
</script> -->
<script>
