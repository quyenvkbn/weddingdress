                ...
                <div class="box">
                    ...
                    <div class="row" style="padding: 10px;">
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo base_url('admin/product/create') ?>" class="btn btn-primary">Thêm mới</a>
                        </div>
                        <div class="col-md-6">
                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    ...
                                    <tr class="remove_<?php echo $value['id'] ?>">
                                        ...
                                        <td>
                                            <div class="mask_sm">
                                                <img src="<?php echo base_url('assets/upload/'.$controller.'/' .$value['slug']. '/'. $value['image']) ?>" alt="anh-cua-<?php echo $value['slug'] ?>" width=200px height=130px>
                                            </div>
                                        </td>
